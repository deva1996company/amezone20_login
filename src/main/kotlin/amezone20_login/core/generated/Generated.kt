package amezone20_login.core.generated
...
import amezone20_login.core.api
import amezone20_login.core.createComponents
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = amezone20_login.core.api as Api<T>
    override val config: ApplicationConfig = amezone20_login.core.config
}
